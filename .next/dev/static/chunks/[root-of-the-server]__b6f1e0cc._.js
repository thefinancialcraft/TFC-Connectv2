...
function HeaderComponent({ user, onLogout, hideSidebar = false }) {
    ...
    const { masterState } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useUser"])();
    // Unified State Sync (Reactive to Master Polling)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HeaderComponent.useEffect": ()=>{
            if (masterState?.device_status) {
                const newData = masterState.device_status;
                setDeviceStatus({
                    on_call: newData.on_call || false,
                    device_model: newData.device_model || 'Unknown Device',
                    android_id: newData.android_id || 'N/A',
                    last_seen: newData.last_seen
                });
                isOnCallRef.current = newData.on_call || false;
            }
        }
    }["HeaderComponent.useEffect"], [
        masterState?.device_status
    ]);
    // Fetch and Subscribe to Device COMMANDS 
    // (We keep this for remote command forwarding to Flutter bridge)
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HeaderComponent.useEffect": ()=>{
            ...
            const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].channel(`device_commands_${localEntryId || displayUser.employeeId}`).on('postgres_changes', {
                event: 'UPDATE',
                schema: 'public',
                table: 'sync_meta',
                filter: filter
                ...
                "HeaderComponent.useEffect.channel": (payload)=>{
                    ...
                    if (!newData || !newData.type || !newData.value) return;
                    // Process Remote Commands (call_to, etc.)
                    const currentEntryId = localEntryId || localStorage.getItem('entry_id');
                    if (newData.entry_id && newData.entry_id === currentEntryId) {
                        if (isBridgeActive) {
                            // Command Forwarding Logic (Already Deduplicated)
                            if (newData.type === 'call_to' && isOnCallRef.current) return;
    ...
    // SENDER Heartbeat: REMOVED (Now handled by get_agent_master_state in UserProvider)
...
_s(HeaderComponent, "/6YJuZF6jWXjJ7B3oyXTUiokGEs=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b6f1e0cc._.js.map