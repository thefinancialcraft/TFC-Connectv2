...
function TeamDetails() {
    ...
    const fetchTeamData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TeamDetails.useCallback[fetchTeamData]": async ()=>{
            ...
            try {
                setLoading(true);
                setError(null);
                const { data: teamData, error: teamError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('teams').select(`id, name, is_active, members, leader_id, organization:organizations(company_name), leader:user_profiles!leader_id(user_name)`).eq('id', id).maybeSingle();
                ...
                const [customersRes, historyRes, syncRes, callLogsRes, sessionRes] = await Promise.all([
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('call_history').select('employee_id, duration, call_type, timestamp, device_id, number, name').in('employee_id', employeeIds).gte('timestamp', start).lte('timestamp', end).limit(50000),
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('call_logs').select('agent_id, duration, is_connected, created_at, disposition').in('agent_id', memberIds).gte('created_at', start).lte('created_at', end).limit(50000),
                    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('user_sessions').select('user_id, last_accessed_at').in('user_id', memberIds).order('last_accessed_at', {
                        ascending: false
                    })
                ]);
                ...
                const { statsMap } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$performanceUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["aggregatePerformance"])(validMembers, historyRes.data || [], callLogsRes.data || [], syncRes.data || [], latestSessions, customersRes.data || []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TeamDetails.useEffect": ()=>{
            if (router.isReady && id && mounted && user) {
                const interval = setInterval({
                    "TeamDetails.useEffect.interval": ()=>fetchTeamData()
                }["TeamDetails.useEffect.interval"], 30000);
                return ({
                    "TeamDetails.useEffect": ()=>clearInterval(interval)
                })["TeamDetails.useEffect"];
            }
        }
    }["TeamDetails.useEffect"], [
    ...
    const chartsData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TeamDetails.useMemo[chartsData]": ()=>{
            ...
            const outcomeCounts = {};
            rawLogs.forEach({
                "TeamDetails.useMemo[chartsData]": (l)=>{
            ...
            const hourlyMap = Object.fromEntries(hourLabels.map({
                "TeamDetails.useMemo[chartsData].hourlyMap": (l)=>[
                        l,
                        0
                    ]
            }["TeamDetails.useMemo[chartsData].hourlyMap"]));
            rawLogs.forEach({
                "TeamDetails.useMemo[chartsData]": (l)=>{
            ...
            rawCustomers.forEach({
                "TeamDetails.useMemo[chartsData]": (c)=>{
                    const d = c.disposition || 'Fresh';
                    dispCounts[d] = (dispCounts[d] || 0) + 1;
                }
            }["TeamDetails.useMemo[chartsData]"]);
            return {
                outcome: Object.entries(outcomeCounts).map({
                    "TeamDetails.useMemo[chartsData]": ([name, value])=>({
                            name,
                            value
                        })
                }["TeamDetails.useMemo[chartsData]"]),
                hourly: hourLabels.map({
                    "TeamDetails.useMemo[chartsData]": (name)=>({
                            name,
                            count: hourlyMap[name]
                        })
                }["TeamDetails.useMemo[chartsData]"]),
                disposition: Object.entries(dispCounts).map({
                    "TeamDetails.useMemo[chartsData]": ([name, value])=>({
                            name,
                            value
                        })
    ...
    if (loading && !team) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AppLayout$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    if (error) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AppLayout$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AppLayout$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                                            ...
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$chart$2f$PieChart$2e$js__$5b$client$5d$__$28$ecmascript$29$__["PieChart"], {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$polar$2f$Pie$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Pie"], {
                                                        ...
                                                        dataKey: "value",
                                                        stroke: "none",
                                                        children: chartsData.outcome.map((_, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$recharts$2f$es6$2f$component$2f$Cell$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Cell"], {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$shared$2f$MemberPerformanceTable$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {
                        members: members,
...
_s(TeamDetails, "v7ipvqFndrtrOANYWvgg5dhXgEY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useUser"]
    ];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf0c0d99._.js.map