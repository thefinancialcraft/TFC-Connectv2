...
"[project]/components/SessionRedirect.tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SessionRedirect() {
    ...
    const lastRedirectedPath = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const lastRedirectTimestamp = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRef"])(0);
    // Stable redirect function
    const applyRedirect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SessionRedirect.useCallback[applyRedirect]": (session)=>{
            if (!session) return;
            ...
            if (isManualHot || isSystemHot) {
                ...
                if (campaignId && customerId) {
                    ...
                    if (currentPath !== normalizedTarget && (lastRedirectedPath.current !== normalizedTarget || now - lastRedirectTimestamp.current > stabilityCooldown)) {
                        ...
                        setTimeout({
                            "SessionRedirect.useCallback[applyRedirect]": ()=>{
                                lastRedirectedPath.current = null;
                            }
                        }["SessionRedirect.useCallback[applyRedirect]"], 5000);
                    }
                }
            } else {
    ...
    // Initial check
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SessionRedirect.useEffect": ()=>{
            const init = {
                "SessionRedirect.useEffect.init": async ()=>{
                    ...
                    if (router.isReady && !router.pathname.includes("/login")) {
                        const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('call_sessions').select('*').eq('user_id', session.user.id).maybeSingle();
                        if (data) {
                            applyRedirect(data);
                        }
                    }
                }
            }["SessionRedirect.useEffect.init"];
            init();
        }
    }["SessionRedirect.useEffect"], [
        router.isReady,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SessionRedirect.useEffect": ()=>{
            ...
            const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].channel(`session_sync_${userId}`).on('postgres_changes', {
                event: 'INSERT',
                schema: 'public',
                table: 'call_sessions',
                filter: `user_id=eq.${userId}`
            }, {
                "SessionRedirect.useEffect.channel": (payload)=>{
                    console.log('[Realtime-Redirect] New session:', payload.new);
                    applyRedirect(payload.new);
                }
            }["SessionRedirect.useEffect.channel"]).on('postgres_changes', {
                event: 'UPDATE',
                schema: 'public',
                table: 'call_sessions',
                filter: `user_id=eq.${userId}`
                ...
                "SessionRedirect.useEffect.channel": (payload)=>{
                    ...
                    const pathParts = currentPath.split('/').filter({
                        "SessionRedirect.useEffect.channel.pathParts": (p)=>Boolean(p) && p !== 'portal'
                    }["SessionRedirect.useEffect.channel.pathParts"]);
            ...
            }["SessionRedirect.useEffect.channel"]).subscribe();
            return ({
                "SessionRedirect.useEffect": ()=>{
...
_s(SessionRedirect, "I8KES+mqhhDZgNPEBZizoEaZOAA=", false, function() {
    return [
...
_c = SessionRedirect;
var _c;
__turbopack_context__.k.register(_c, "SessionRedirect");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
function UserProvider({ children }) {
    _s();
    const { user, loading, error, mounted, statusMessage, refetchUser } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAuthGuard$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["useAuthGuard"])();
...
_s(UserProvider, "b8WoAknzg6R3oO89pPrYozVl3X4=", false, function() {
    return [
        ...
        "GlobalCallHandler.useEffect": ()=>{
            ...
            const notifyLeadOwner = {
                "GlobalCallHandler.useEffect.notifyLeadOwner": async (ownerId, customerName)=>{
                    ...
                    const notifyChannel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].channel(channelName);
                    await notifyChannel.subscribe({
                        "GlobalCallHandler.useEffect.notifyLeadOwner": async (status)=>{
                            if (status === 'SUBSCRIBED') {
                                await notifyChannel.send({
                                    ...
                                    payload: {
                                        actor_id: user.uid,
                                        actor_name: user.displayName || user.user_name,
                                        customer_name: customerName,
                                        message: `${user.displayName || user.employeeId} is trying to reach ${customerName}`,
                                        employee_id: user.employeeId
                                    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react/jsx-dev-runtime.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SessionRedirect$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/SessionRedirect.tsx [client] (ecmascript)");
...
function PortalContainer({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$UserProvider$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["UserProvider"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SessionRedirect$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/components/PortalContainer.tsx",
                lineNumber: 29,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AppLayout$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__112a413a._.js.map