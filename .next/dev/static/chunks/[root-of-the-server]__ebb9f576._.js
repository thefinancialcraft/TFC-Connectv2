...
"[project]/pages/portal/profile-completion.tsx [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProfileCompletion() {
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"])();
    const { user, mounted: authMounted } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useUser"])();
    const [mounted, setMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProfileCompletion.useEffect": ()=>{
            const fetchProfile = {
                "ProfileCompletion.useEffect.fetchProfile": async ()=>{
                    ...
                    if (session) {
                        try {
                            ...
                            if (profileData.success && profileData.user) {
                                ...
                                const { data: fullProfile } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].from('user_profiles').select('*').eq('user_id', user.uid).maybeSingle();
                                // Format dates for input fields (YYYY-MM-DD format) - client-only, fixed format
                                const formatDateForInput = {
                                    "ProfileCompletion.useEffect.fetchProfile.formatDateForInput": (dateString)=>{
                                        if (!dateString || ("TURBOPACK compile-time value", "object") === 'undefined') return "";
                                        try {
                                ...
                                }["ProfileCompletion.useEffect.fetchProfile.formatDateForInput"];
                                setFormData({
                                    // basic_info
                            ...
                            setFormData({
                                "ProfileCompletion.useEffect.fetchProfile": (prev)=>({
                                        ...prev,
                            ...
                            }["ProfileCompletion.useEffect.fetchProfile"]);
                        }
                    }
                }
            }["ProfileCompletion.useEffect.fetchProfile"];
    ...
    const handleFileUpload = async (fieldName, fileUrl)=>{
        ...
        try {
            const { data: { session } } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
            if (!session) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dialogUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["showError"])("You must be logged in to save changes", "Authentication Error");
                return;
            }
            ...
            if (!response.ok) {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dialogUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["showError"])(data.error || "Failed to save file URL", "Error");
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dialogUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["showSuccess"])(`${fieldName.replace('_', ' ')} uploaded and saved successfully!`, "Success");
            }
        } catch (error) {
            console.error('Error saving file URL:', error);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dialogUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["showError"])(error.message || "An error occurred while saving", "Error");
            // Revert form data on error
            setFormData((prev)=>({
                    ...prev,
                    [fieldName]: ""
    ...
    const handleSaveAndComplete = async ()=>{
        ...
        if (!formData.user_name || !formData.contact_no) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dialogUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["showError"])("Please fill in required fields: Full Name and Contact Number", "Validation Error");
            return;
        }
        setIsSaving(true);
        try {
            ...
            const data = await response.json();
            if (!response.ok) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dialogUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["showError"])(data.error || "Failed to save changes", "Error");
                setIsSaving(false);
                return;
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dialogUtils$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["showSuccess"])("Profile completed successfully! Your application is now pending approval.", "Success");
...
_s(ProfileCompletion, "kiTbIAiXZqtEg1uaqKUy+iVSbXQ=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$UserContext$2e$tsx__$5b$client$5d$__$28$ecmascript$29$__["useUser"]
    ];
...
const __TURBOPACK__default__export__ = _c2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dynamic$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"])(_c1 = ()=>Promise.resolve(ProfileCompletion), {
    ssr: false
});
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "ProfileCompletion");
...
"[next]/entry/page-loader.ts { PAGE => \"[project]/pages/portal/profile-completion.tsx [client] (ecmascript)\" } [client] (ecmascript)", ((__turbopack_context__, module, exports) => {

const PAGE_PATH = "/portal/profile-completion";
(window.__NEXT_P = window.__NEXT_P || []).push([
    PAGE_PATH,
    ()=>{
        return __turbopack_context__.r("[project]/pages/portal/profile-completion.tsx [client] (ecmascript)");
    }
]);
...
"[hmr-entry]/hmr-entry.js { ENTRY => \"[project]/pages/portal/profile-completion.tsx\" }", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.r("[next]/entry/page-loader.ts { PAGE => \"[project]/pages/portal/profile-completion.tsx [client] (ecmascript)\" } [client] (ecmascript)");
}),
]);

//# sourceMappingURL=%5Broot-of-the-server%5D__ebb9f576._.js.map