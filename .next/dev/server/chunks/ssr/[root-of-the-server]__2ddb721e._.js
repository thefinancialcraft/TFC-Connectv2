...
"[project]/components/SessionRedirect.tsx [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SessionRedirect() {
    ...
    const lastRedirectedPath = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])(null);
    const lastRedirectTimestamp = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])(0);
    // Stable redirect function
    const applyRedirect = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useCallback"])((session)=>{
        if (!session) return;
        ...
        if (isManualHot || isSystemHot) {
            ...
            if (campaignId && customerId) {
                ...
                if (currentPath !== normalizedTarget && (lastRedirectedPath.current !== normalizedTarget || now - lastRedirectTimestamp.current > stabilityCooldown)) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        const init = async ()=>{
            ...
            if (router.isReady && !router.pathname.includes("/login")) {
                const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('call_sessions').select('*').eq('user_id', session.user.id).maybeSingle();
                if (data) {
                    applyRedirect(data);
                }
            }
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].channel(`session_sync_${userId}`).on('postgres_changes', {
            event: 'INSERT',
            schema: 'public',
            table: 'call_sessions',
...
function HeaderComponent({ user, onLogout, hideSidebar = false }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].channel(`device_sync_${localEntryId || displayUser.employeeId}`).on('postgres_changes', {
            event: '*',
            schema: 'public',
            table: 'sync_meta',
            filter: filter
            ...
            if (newData.entry_id && newData.entry_id === currentEntryId) {
                ...
                if (isBridgeActive && newData.type && newData.value) {
                    ...
                    if (!isLocalDuplicate && !isRemoteDuplicate && !isStickyDuplicate) {
                        ...
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$flutterBridge$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["notifyFlutter"])(newData.type, newData.value);
    ...
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        ...
        const syncNotificationChannel = async ()=>{
            ...
            const channel = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].channel(channelName).on('postgres_changes', {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$dialogUtils$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["showWarning"])(payload.payload.message || "Someone is accessing your lead", "Lead Access Alert");
...
;
;
const BottomNav = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["memo"])(function BottomNav({ activeNav, userRole, isSuperAdmin, isClient, designation }) {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
...
"[project]/hooks/useCallSessionRedirect.ts [ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useCallSessionRedirect(userId) {
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$router$2e$js__$5b$ssr$5d$__$28$ecmascript$29$__["useRouter"])();
    const lastPulseRef = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useRef"])(0);
    const checkActiveSession = async ()=>{
        ...
        try {
            ...
            const { data: sessions, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["supabase"].from('call_sessions').select('*').eq('user_id', userId);
            if (error) throw error;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AppLogo$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/AppLogo.tsx [ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCallSessionRedirect$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useCallSessionRedirect.ts [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCallSessionRedirect$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__
]);
[__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Header$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$authService$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$UtilitySidebar$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCallSessionRedirect$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function AppLayout({ children, hideSidebar = false, hideHeader = false }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useCallSessionRedirect$2e$ts__$5b$ssr$5d$__$28$ecmascript$29$__["useCallSessionRedirect"])(user?.uid);
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/react/jsx-dev-runtime [external] (react/jsx-dev-runtime, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SessionRedirect$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/SessionRedirect.tsx [ssr] (ecmascript)");
...
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SessionRedirect$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__,
...
function PortalContainer({ children }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$UserProvider$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["UserProvider"], {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SessionRedirect$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/components/PortalContainer.tsx",
                lineNumber: 29,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$AppLayout$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2ddb721e._.js.map