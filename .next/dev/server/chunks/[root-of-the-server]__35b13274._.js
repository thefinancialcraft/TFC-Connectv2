...
"[externals]/date-holidays [external] (date-holidays, cjs)", ((__turbopack_context__, module, exports) => {

const mod = __turbopack_context__.x("date-holidays", () => require("date-holidays"));

module.exports = mod;
}),
"[project]/pages/api/google/fetch-holidays.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (authHeader) {
            try {
                ...
                if (primaryRes.ok) {
                    const userEvents = primaryData.items?.map((item)=>({
                            id: item.id,
        ...
        if (allHolidays.length === 0 && !authHeader && !API_KEY) {
            ...
            const Holidays = __turbopack_context__.r("[externals]/date-holidays [external] (date-holidays, cjs)");
            const hd = new Holidays('IN');
            const holidaysData = hd.getHolidays(Number(year));
            allHolidays = holidaysData.filter((h)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__35b13274._.js.map