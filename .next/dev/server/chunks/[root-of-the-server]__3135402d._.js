...
"[project]/pages/api/notifications/mark-as-seen.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        const { data: { user }, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"].auth.getUser(token);
        if (authError || !user) {
            return res.status(401).json({
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseAdmin"].from('notifications').update({
            is_seen: true
        }).eq('user_id', user.id);
        if (!markAll && id) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3135402d._.js.map