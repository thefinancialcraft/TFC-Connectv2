...
"[project]/pages/api/dashboard_charts.ts [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        const { data: userProfile, error: profileError } = await (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabaseAdmin"] || __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$ts__$5b$api$5d$__$28$ecmascript$29$__["supabase"]).from("user_profiles").select("organization_id, role, designation").eq("user_id", requestUserId).maybeSingle();
        if (profileError) {
        ...
        try {
            ...
            (finalData.hourlyStats || []).forEach((h)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ba93ceb3._.js.map