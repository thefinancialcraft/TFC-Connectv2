...
interface DocumentUploadFieldProps {
  ...
  handleCopy: (fieldId: string, value: string | null | undefined) => void;
}
...
const DocumentUploadField = ({
  ...
  const isImage = fileUrl && (
    ...
    fileUrl.includes('image/') // Some signed URLs might have type in query
  );
  ...
  if (category === "documents") {
    return (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <DocumentUploadField fieldName="profile_pic_url" label="Profile Picture" acceptedTypes="image/*" formData={formData} handleInputChange={handleInputChange} onFileUpload={onFileUpload} copiedField={copiedField} handleCopy={handleCopy} />
          <DocumentUploadField fieldName="pancard_url" label="PAN Card" acceptedTypes="image/*,.pdf" formData={formData} handleInputChange={handleInputChange} onFileUpload={onFileUpload} copiedField={copiedField} handleCopy={handleCopy} />
          <DocumentUploadField fieldName="aadhar_front_url" label="Aadhar Card (Front)" acceptedTypes="image/*,.pdf" formData={formData} handleInputChange={handleInputChange} onFileUpload={onFileUpload} copiedField={copiedField} handleCopy={handleCopy} />
          <DocumentUploadField fieldName="aadhar_back_url" label="Aadhar Card (Back)" acceptedTypes="image/*,.pdf" formData={formData} handleInputChange={handleInputChange} onFileUpload={onFileUpload} copiedField={copiedField} handleCopy={handleCopy} />
          <DocumentUploadField fieldName="qualification_marksheet_url" label="Qualification Marksheet" acceptedTypes="image/*,.pdf" formData={formData} handleInputChange={handleInputChange} onFileUpload={onFileUpload} copiedField={copiedField} handleCopy={handleCopy} />
          <DocumentUploadField fieldName="bank_passbook_url" label="Bank Passbook" acceptedTypes="image/*,.pdf" formData={formData} handleInputChange={handleInputChange} onFileUpload={onFileUpload} copiedField={copiedField} handleCopy={handleCopy} />
        </div>
      </div>
    );
  }
