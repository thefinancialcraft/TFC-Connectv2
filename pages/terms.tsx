                                ...
                                <div className="space-y-6 text-gray-500 text-sm md:text-base leading-relaxed">
                                    ...
                                    <div className="bg-gray-50/50 rounded-2xl p-6 border border-gray-100">
                                        <h4 className="text-lg font-bold text-[#263238] mb-3 flex items-center gap-3">
                                            <span className="w-10 h-10 bg-indigo-50 text-[#4b33e8] rounded-xl flex items-center justify-center text-lg border border-indigo-100/50 shadow-sm"><i className="fi fi-rr-check-circle"></i></span>
                                            You must:
                                        </h4>
                                    ...
                                    <div className="bg-red-50/30 rounded-2xl p-6 border border-red-100">
                                        <h4 className="text-lg font-bold text-[#263238] mb-3 flex items-center gap-3">
                                            <span className="w-10 h-10 bg-red-50 text-red-500 rounded-xl flex items-center justify-center text-lg border border-red-100 shadow-sm"><i className="fi fi-rr-cross-circle"></i></span>
                                            You must NOT:
                                        </h4>
                                        <div className="pl-13 space-y-3">
                                            <ul className="space-y-2 ml-2">
