            ...
            <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
              <div className="mb-4 sm:hidden">
                          ...
                          {calendarDays.map((day, index) => {
                            ...
                            return (
                              <button
                                ...
                                className={`text-xs py-2 rounded-lg transition-all ${isSelected
                ...
                <div className="flex bg-gray-100 p-1 rounded-lg mb-4 w-full sm:w-auto self-start">
                  <button
                    ...
                    className={`flex-1 sm:flex-none px-4 py-1.5 text-xs font-semibold rounded-md transition-all ${source === 'mobile'
                  ...
                  <button
                    ...
                    className={`flex-1 sm:flex-none px-4 py-1.5 text-xs font-semibold rounded-md transition-all ${source === 'crm'
                        ? 'bg-white text-purple-600 shadow-sm'
                        : 'text-gray-500 hover:text-gray-700'
                      }`}
                    style={{ fontFamily: "'Poppins', sans-serif" }}
              ...
              <div className="hidden sm:flex sm:items-center sm:justify-between mb-6">
                ...
                <div className="flex bg-gray-100 p-1 rounded-lg">
                  <button
                    onClick={() => setSource('mobile')}
                    className={`px-4 py-1.5 text-xs font-semibold rounded-md transition-all ${source === 'mobile'
                        ? 'bg-white text-purple-600 shadow-sm'
                        : 'text-gray-500 hover:text-gray-700'
                      }`}
                    style={{ fontFamily: "'Poppins', sans-serif" }}
                  ...
                  <button
                    onClick={() => setSource('crm')}
                    className={`px-4 py-1.5 text-xs font-semibold rounded-md transition-all ${source === 'crm'
                        ? 'bg-white text-purple-600 shadow-sm'
                        : 'text-gray-500 hover:text-gray-700'
                      }`}
                    style={{ fontFamily: "'Poppins', sans-serif" }}
                          ...
                          {calendarDays.map((day, index) => {
                            ...
                            return (
                              <button
                                key={index}
                                onClick={() => handleDateSelect(day.date)}
                                className={`text-sm py-2.5 rounded-lg transition-all ${isSelected
                                    ? 'text-white font-semibold'
                                    : day.isCurrentMonth
                                      ? 'text-gray-700 hover:bg-gray-100'
                                      : 'text-gray-400'
              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-white divide-y divide-gray-100 relative min-h-[400px]">
                    {loading ? (
                      <tr>
                        <td colSpan={source === 'mobile' ? 8 : 10} className="px-6 py-32 text-center">
                          <div className="flex flex-col items-center justify-center space-y-4">
                            <div className="relative">
                              <div className="w-16 h-16 border-4 border-purple-100 border-t-purple-600 rounded-full animate-spin"></div>
                              <div className="absolute inset-0 flex items-center pt-5 justify-center">
                                <i className="fi flex fi-rr-cloud-download text-purple-600  animate-bounce"></i>
                              </div>
                            </div>
                            <div className="flex flex-col items-center">
                              <p className="text-sm font-black uppercase tracking-[0.2em] text-purple-600">Fetching Data</p>
                              <p className="text-[10px] font-medium text-gray-400 mt-1">Please wait while we sync your records...</p>
                            </div>
                          </div>
                        </td>
                      </tr>
              ...
              {totalPages > 1 && (
                <div className="mt-6 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-gray-100 pt-6">
                  <div className="text-xs text-gray-500 font-medium">
                    Showing <span className="text-gray-900 font-bold">{((currentPage - 1) * 50) + 1}</span> to <span className="text-gray-900 font-bold">{Math.min(currentPage * 50, filteredActivities.length)}</span> of <span className="text-gray-900 font-bold">{filteredActivities.length}</span> entries
                  </div>
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => setCurrentPage(prev => Math.max(prev - 1, 1))}
                      disabled={currentPage === 1}
                      className="flex h-9 w-9 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-600 transition-all hover:border-purple-500 hover:text-purple-600 disabled:opacity-30 disabled:hover:border-gray-200 disabled:hover:text-gray-600"
                    >
                      ...
                      {Array.from({ length: Math.min(5, totalPages) }, (_, i) => {
                        ...
                        return (
                          <button
                            ...
                            className={`flex h-9 w-9 items-center justify-center rounded-lg text-xs font-bold transition-all ${currentPage === pageNum
                                ? 'bg-[#4b33e8] text-white shadow-md'
